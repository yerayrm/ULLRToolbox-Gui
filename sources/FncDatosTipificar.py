...
class FncDatosTipificar():
	...
	#Constructor
	def __init__(self, ui, d_tipificar, d_multiselector):
		self.ui = ui
	...
	def accept(self):
		...
		if (factor == "Sin factor"):
			comando = "datos.tipificados=p.tipica.fnc(datos, variables=" + variables + ")"
		else:
			comando = "datos.tipificados=p.tipica.fnc(datos, variables=" + variables + ", que.factor='" + factor + "')"
