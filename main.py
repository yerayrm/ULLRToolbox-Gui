...
def main(argv=None):
    ...
    fncDatosTipificar   = FncDatosTipificar(ui, d_tipificar)
    ...
    fncAnlsCorrelacion  = FncAnlsCorrelacion(ui, d_correlacion)
    fncAnlsContraste    = FncAnlsContraste(ui, d_contr_inter, d_contr_intra)
    fncAnlsAnova        = FncAnlsAnova(ui, d_anova_inter, d_anova_intra, d_anova_split)
